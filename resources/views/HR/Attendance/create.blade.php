...
<section id="multiple-column-form">
    <div class="row">
      <div class="col-9"> 
        ...
        <form action="{{route('attendance.store')}}" method="POST" id="employee_form">
          @csrf
              ...
              <div class="row">
                <div class="col-md-6 mb-1">
                 ...
                 <div class="col-md-6 mb-1">
                    ...
                    <input type="text" id="current_date" name="Date" class="form-control flatpickr-basic flatpickr-input  @error('employee_id') error @enderror" placeholder="YYYY-MM-DD" readonly="readonly">
                    @error('Date')
                    <div class="danger text-danger">{{ $message }}</div>
                    @enderror
