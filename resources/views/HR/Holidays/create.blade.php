...
<section id="multiple-column-form">
    <div class="row">
      <div class="col-9"> 
        ...
        <form action="{{route('holiday.store')}}" method="POST" id="employee_form">
          @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-1">
                  ...
                  <div class="col-md-6 mb-1">
                    ...
                    <input type="text" id="current_date" name="Date" class="form-control flatpickr-date-time flatpickr-input active  @error('Date') error @enderror" placeholder="YYYY-MM-DD" readonly="readonly">
                    @error('Date')
                    <div class="danger text-danger">{{ $message }}</div>
                    @enderror
