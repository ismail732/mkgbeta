...
<section id="multiple-column-form">
    <div class="row">
      <div class="col-9"> 
        ...
        <form action="{{route('holiday.update',$holiday->id)}}" method="POST" id="employee_form">
          @csrf
          @method('PUT')
          <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6 mb-1">
                  <label class="form-label" for="fp-date-time">Title</label>
                    <input
                      type="text"
                      class="form-control  @error('title') error @enderror"
                      name="title" value="{{$holiday->title}}"
                      placeholder="Title" 
                    />
                    @error('title')
                  ...
                  <div class="col-md-6 mb-1">
                    ...
                    <input type="text" id="current_date" name="Date" class="form-control flatpickr-date-time flatpickr-input active  @error('Date') error @enderror" placeholder="YYYY-MM-DD" value="{{$holiday->Date}}" readonly="readonly">
                    @error('Date')
                    <div class="danger text-danger">{{ $message }}</div>
                    @enderror
