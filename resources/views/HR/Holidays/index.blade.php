		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-header border-bottom">
                    ...
                    <a type="button" class="btn btn-relief-primary click_if_invalid"  href="{{route('holiday.create')}}" id="">Add New</a>
				</div>
				<!-- Modal -->
