    ...
    <div class="card mb-0">
      <div class="card-body">
        <a href="#" class="brand-logo">
          ...
          <h2 class="brand-text text-primary ms-1">{{ __('MKG')}}</h2>
        </a>

        <h4 class="card-title mb-1">{{ __('Welcome to Multan Kitab Ghar!') }} 👋</h4>
        ...
        <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
          ...
          <div class="mb-1">
            <div class="form-check">
              <input class="form-check-input" name="remember" type="checkbox" id="remember-me" tabindex="3" {{ old('remember') ? 'checked' : '' }} />
