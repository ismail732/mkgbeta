          ...
          <h4 class="card-title">Add Series Information</h4>
           <a type="button" class="btn btn-relief-primary click_if_invalid" data-bs-toggle="modal" data-bs-target="#large" href="javascript:void(0)" id="add_new_btn">Add New</a>
              ...
              <div
                ...
                aria-hidden="true">
                    <form class="" id="series_form" name="series_form" method="post" action="{{route('series.store')}}">
                        @csrf
						          <input type="hidden" name="series_id" id="series_id">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                <h4 class="modal-title" id="model_heading">Add Series Info</h4>
...
$(document).ready(function() {
    ...
    $('body').on('click', '.edit-btn', function () {
      ...
      $.get("{{ route('series.index') }}" +'/' + series_id +'/edit', function (data) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == true) {
                            ...
                            table.draw();
                            //alert
                            toastr['success']('👋 Series saved', 'Success!', {
                                closeButton: true,
                                tapToDismiss: false,
                            });
