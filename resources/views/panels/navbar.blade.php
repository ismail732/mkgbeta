@php
    $profile_photo_url=asset('images/portrait/small/avatar-s-11.jpg');
    if(Auth::user()->avatar != NULL && Auth::user()->avatar!=""){
        //need to set profile upload path
        $profile_photo_url=Auth::user()->avatar;
    }
@endphp
      ...
      <ul class="nav navbar-nav">
        <li class="nav-item">
          <a class="navbar-brand" href="{{ url('/') }}">
            ...
            <h2 class="brand-text mb-0">MKG</h2>
          </a>
        </li>
      </ul>
    </div>
